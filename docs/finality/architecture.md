...
This is the **finality** proof: the pipeline that proves two consecutive epochs
justified, and the machines it runs on. The fast confirmation rule is a separate
product with separate circuits and a separate threshold, and its design is
[../fcr/architecture.md](../fcr/architecture.md). Nothing on this page describes
it.
...
[assumptions.md](assumptions.md) holds what the proofs trust, and
[../shared/assumptions.md](../shared/assumptions.md) holds what they share with
FCR.
...
[../shared/gossip.md](../shared/gossip.md) holds the measured cost of the
attestation feed and the case for a forked node.
